...
This module implements the voice input/output pipeline using Groq's Whisper for
...
class VoicePipeline:
    ...
    def __init__(self, groq_api_key: str = None, use_mock: bool = False):
        ...
        Args:
            groq_api_key: Groq API key for Whisper (optional)
        ...
        if groq_api_key and not use_mock:
            try:
                ...
                # Fall back to mock mode if client fails
                self.use_mock = True
